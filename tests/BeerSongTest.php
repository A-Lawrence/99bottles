...
class BeerSongTest extends PHPUnit\Framework\TestCase
{
    ...
    {
        $expected = "99 bottles of beer on the wall, 99 bottles of beer." . PHP_EOL .
                    "Take one down and pass it around, 98 bottles of beer on the wall." . PHP_EOL;
        $song = new BeerSong();
    ...
    {
        $expected = "2 bottles of beer on the wall, 2 bottles of beer." . PHP_EOL .
    ...
    {
        $expected = "1 bottle of beer on the wall, 1 bottle of beer." . PHP_EOL .
    ...
    public function testACoupleVerses()
    {
        $expected = "99 bottles of beer on the wall, 99 bottles of beer." . PHP_EOL .
                    "Take one down and pass it around, 98 bottles of beer on the wall." . PHP_EOL .
                    PHP_EOL .
                    "98 bottles of beer on the wall, 98 bottles of beer." . PHP_EOL .
                    "Take one down and pass it around, 97 bottles of beer on the wall." . PHP_EOL;
        $song = new BeerSong();
